...
Highest pr between both was P. falciparum in Burkina Faso
Look at rural vs urban?
Look at pos rates over time 
RDT is a malaria diagnostic test
...
## Globally 
# Looking at falciparum vivax, omitting DHS data and confidential data (would have to request)
```{r}
